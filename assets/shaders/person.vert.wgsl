...
fn get_model_matrix(world_position: vec3<f32>, scale: f32, rotation_xy: f32) -> mat4x4<f32> {
    ...
    let scale_x = 0.8 * scale;
    let scale_y = 0.8 * scale;
    let scale_z = 1.0 * scale;
