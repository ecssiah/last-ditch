...
fn approx_set_eq() {
    let test_cases = vec![
        ApproxSetEqCase {
            ...
            aabb_vec1: vec![
                AABB::new(Vec3::broadcast(0.0), Vec3::broadcast(1.0)),
                AABB::new(Vec3::new(1.0, 0.0, 0.0), Vec3::broadcast(1.0)),
                AABB::new(Vec3::new(0.0, 1.0, 0.0), Vec3::broadcast(1.0)),
                AABB::new(Vec3::new(0.0, 0.0, 1.0), Vec3::broadcast(1.0)),
            ],
            aabb_vec2: vec![
                AABB::new(Vec3::new(0.0, 0.0, 1.0), Vec3::broadcast(1.0)),
                AABB::new(Vec3::new(0.0, 1.0, 0.0), Vec3::broadcast(1.0)),
        ...
        ApproxSetEqCase {
            ...
            aabb_vec1: vec![
                ...
                AABB::new(Vec3::new(1.0, 0.0, 0.0), Vec3::broadcast(1.0)),
                AABB::new(Vec3::new(0.0, 1.0, 0.0), Vec3::broadcast(1.0)),
                AABB::new(Vec3::new(EPSILON, 0.0, 1.0), Vec3::broadcast(1.0)),
            ],
            aabb_vec2: vec![
                AABB::new(Vec3::new(0.0, 0.0, 1.0), Vec3::broadcast(1.0)),
                AABB::new(Vec3::new(0.0, 1.0, 0.0), Vec3::broadcast(1.0)),
        ...
        ApproxSetEqCase {
            ...
            aabb_vec1: vec![
                ...
                AABB::new(Vec3::new(1.0, 0.0, 0.0), Vec3::broadcast(1.0)),
                AABB::new(Vec3::new(0.0, 1.0, 0.0), Vec3::broadcast(1.0)),
                AABB::new(Vec3::new(2.0 * EPSILON, 0.0, 1.0), Vec3::broadcast(1.0)),
            ],
            aabb_vec2: vec![
                AABB::new(Vec3::new(0.0, 0.0, 1.0), Vec3::broadcast(1.0)),
                AABB::new(Vec3::new(0.0, 1.0, 0.0), Vec3::broadcast(1.0)),
