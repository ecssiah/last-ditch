...
pub const CELL_VOLUME_IN_METERS: f32 = CELL_SIZE_IN_METERS * CELL_SIZE_IN_METERS * CELL_SIZE_IN_METERS;
...
pub const SECTOR_VOLUME_IN_CELLS: usize = SECTOR_SIZE_IN_CELLS * SECTOR_SIZE_IN_CELLS * SECTOR_SIZE_IN_CELLS;

pub const SECTOR_RADIUS_IN_METERS: f32 = CELL_SIZE_IN_METERS * SECTOR_RADIUS_IN_CELLS as f32 + CELL_RADIUS_IN_METERS;
...
pub const SECTOR_VOLUME_IN_METERS: f32 = SECTOR_SIZE_IN_METERS * SECTOR_SIZE_IN_METERS * SECTOR_SIZE_IN_METERS;

pub const WORLD_RADIUS_IN_SECTORS: usize = 4;
...
pub const WORLD_VOLUME_IN_SECTORS: usize = WORLD_SIZE_IN_SECTORS * WORLD_SIZE_IN_SECTORS * WORLD_SIZE_IN_SECTORS;

pub const WORLD_RADIUS_IN_CELLS: usize = SECTOR_SIZE_IN_CELLS * WORLD_RADIUS_IN_SECTORS + SECTOR_RADIUS_IN_CELLS;
...
pub const WORLD_VOLUME_IN_CELLS: usize = WORLD_SIZE_IN_CELLS * WORLD_SIZE_IN_CELLS * WORLD_SIZE_IN_CELLS;

pub const WORLD_RADIUS_IN_METERS: f32 = CELL_SIZE_IN_METERS * WORLD_RADIUS_IN_CELLS as f32 + CELL_RADIUS_IN_METERS;
...
pub const WORLD_VOLUME_IN_METERS: f32 = WORLD_SIZE_IN_METERS * WORLD_SIZE_IN_METERS * WORLD_SIZE_IN_METERS;
