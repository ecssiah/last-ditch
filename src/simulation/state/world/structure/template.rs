...
pub fn trade_platform(direction: grid::Direction) -> Vec<(block::Kind, IVec3)> {
    #[rustfmt::skip]
    let template = vec![
        (block::Kind::Engraved2,    IVec3::new(-2, -1,  0)),
        (block::Kind::None,         IVec3::new(-1, -1,  0)),
        (block::Kind::None,         IVec3::new( 0, -1,  0)),
        (block::Kind::None,         IVec3::new( 1, -1,  0)),
        (block::Kind::Engraved2,    IVec3::new( 2, -1,  0)),

        (block::Kind::Engraved2,    IVec3::new(-2,  0,  0)),
        ...
        (block::Kind::Stone2,       IVec3::new(-2,  0, -1)),
        (block::Kind::Stone2,       IVec3::new(-1,  0, -1)),
        (block::Kind::Stone2,       IVec3::new( 0,  0, -1)),
        (block::Kind::Stone2,       IVec3::new( 1,  0, -1)),
        (block::Kind::Stone2,       IVec3::new( 2,  0, -1)),

        (block::Kind::Stone2,       IVec3::new(-2,  1, -1)),
        (block::Kind::Stone2,       IVec3::new(-1,  1, -1)),
        (block::Kind::Stone2,       IVec3::new( 0,  1, -1)),
        (block::Kind::Stone2,       IVec3::new( 1,  1, -1)),
        (block::Kind::Stone2,       IVec3::new( 2,  1, -1)),

        (block::Kind::Stone2,       IVec3::new(-2,  2, -1)),
        (block::Kind::Stone2,       IVec3::new(-1,  2, -1)),
        (block::Kind::Stone2,       IVec3::new( 0,  2, -1)),
        (block::Kind::Stone2,       IVec3::new( 1,  2, -1)),
        (block::Kind::Stone2,       IVec3::new( 2,  2, -1)),

        (block::Kind::Stone2,       IVec3::new(-2,  3, -1)),
        (block::Kind::Stone2,       IVec3::new(-1,  3, -1)),
        (block::Kind::Stone2,       IVec3::new( 0,  3, -1)),
        (block::Kind::Stone2,       IVec3::new( 1,  3, -1)),
        (block::Kind::Stone2,       IVec3::new( 2,  3, -1)),

        (block::Kind::Stone2,       IVec3::new(-2,  4, -1)),
        (block::Kind::Stone2,       IVec3::new(-1,  4, -1)),
        (block::Kind::Stone2,       IVec3::new( 0,  4, -1)),
        (block::Kind::Stone2,       IVec3::new( 1,  4, -1)),
        (block::Kind::Stone2,       IVec3::new( 2,  4, -1)),
    ];
