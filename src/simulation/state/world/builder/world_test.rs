...
pub fn construct(world: &mut World) {
    build_rooms(world);
    build_north_test_room(world);
    build_graph_test_room(world);
...
fn build_graph_test_room(world: &mut World) {
    ...
    build_graph_test_center_room(world);
    build_graph_test_constricted_entrance_room(world);
    build_graph_test_expanded_entrance_room(world);
    build_graph_test_multiple_entrance_room(world);
    build_graph_test_vertical_entrance_rooms(world);
}
...
fn build_graph_test_center_room(world: &mut World) {
    ...
    build_chunk_room(world, chunk_position, entrances);
}
