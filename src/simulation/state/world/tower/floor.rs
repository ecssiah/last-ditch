use crate::{
    simulation::state::world::{
        area::{self, area_id::AreaID, AreaKind},
...
pub struct Floor {
    ...
    pub id_area_map: HashMap<AreaID, Area>,
    pub kind_id_map: HashMap<AreaKind, AreaID>,
}
